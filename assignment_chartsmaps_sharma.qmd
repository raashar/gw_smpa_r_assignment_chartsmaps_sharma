...
ggplot(senate_results, aes(x = is_r_above_trump_new)) + 
  geom_bar(fill = "#9ebcda") +
  xlab("Performance") +
  ylab("Number of counties") +
  labs(title = "Republican senate candidate performance compared to Trump in GA counties") +
  theme_clean()
...
ggplot(governor_results, aes(x = is_r_above_trump_new)) + 
  geom_bar(fill = "#9ebcda") +
  xlab("Performance") +
  ylab("Number of counties") +
  labs(title = "Republican governor candidate performance compared to Trump in GA counties") +
  theme_clean()
...
senate_drops %>%
  ...
  xlab("Counties") +
  ylab("Percentage") +
  labs(title = "Highest drops between Republican candidates and Trump in GA counties (Top 10)") +
  theme_clean()
...
dem_margin_s %>%
  ...
  labs(title = "Highest Democratic margins of victory for senate race in GA counties (Top 10)",
       subtitle = "2022") +
  theme_clean()
...
dem_margin_g %>%
  ...
  xlab("Counties") +
  ylab("Democratic margin of victory percentage") +
  labs(title = "Highest Democratic margins of victory for governor race in GA counties (Top 10)",
       subtitle = "2022") +
  theme_clean()
...
r_diff %>%
  ...
  labs(title = "Pct differences between Republican senate and governor candidates in GA counties (Top 10)",
       subtitle = "2022") +
  theme_clean()
...
tm_shape(new_senate_sf) + 
  tm_fill(col="pct_r_above_trump", title = "Percent difference from Trump") + 
  tm_layout(main.title = "Republican senate candidate performance compared to Trump in GA counties",
            main.title.size = 0.7,
            legend.outside = TRUE,
...
tm_shape(new_governor_sf) + 
  tm_fill(col="pct_r_above_trump", title = "Percent difference from Trump") + 
  tm_layout(main.title = "Republican governor candidate performance compared to Trump in GA counties",
            main.title.size = 0.7,
            legend.outside = TRUE,
            legend.outside.size = 0.5,
            legend.text.size = 1) + 
...
tm_shape(new_senate_sf) + 
  ...
  tm_layout(main.title = "Senate margins of victory for Democratic candidates in GA counties",
            main.title.size = 0.7,
            legend.outside = TRUE,
...
tm_shape(new_governor_sf) + 
  tm_fill(col="d_margin", title = "Democratic margin of victory percentages") + 
  tm_layout(main.title = "Governor margins of victory for Democratic candidates in GA counties",
            main.title.size = 0.7,
            legend.outside = TRUE,
            legend.outside.size = 0.5,
            legend.text.size = 1) + 
...
tm_shape(sen_gov_sf) + 
  tm_fill(col="pct_r_diff", title = "Percent differences") + 
  tm_layout(main.title = "Pct differences between Republican senate and governor candidates in GA counties",
            main.title.size = 0.7,
            legend.outside = TRUE,
            legend.outside.size = 0.5,
            legend.text.size = 1) + 
